def check_region(cellX, cellY):
    ...
    if x == 19 and y in range(23,32 +1): return 'Sea_of_Ghosts_E'
    if x == 20 and y in range(23,33 +1): return 'Sea_of_Ghosts_E'
    ...
    if x in range(47,49 +1) and y in range(13,22 +1): return 'Telvanni_Isles'
